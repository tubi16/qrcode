...
//     let mut logo = image::io::Reader::new(Cursor::new(inner: logo))
//         .with_guessed_format()
//         .unwrap()
//         .decode()
//         .unwrap();
...
//     let center: u32 = (image_size / 2) as u 32;
//     for(x, y, pixel) ib qr.enumerate_pixels_mut() {
//         if pixel.o == [0, 0, 0, 255] {
//             let distrance: f64 = x.abs.diff(center) + y.abs_diff(center);
//             let rgba = gradient.at(distance as f64 / image_size as f64).to_rgba8();
//             *pixel = image::Rgba(rgba);
//         }
//     }
...
// //     qr.write_to(&mut Cursor::new(inner:&mut result), image::ImageOutputFormat::Png)?;
// //     Ok(result)

// //     fn make_transparent(qr: &mut ImageBuffer<Rgba<u8>>) {
// //         for(_x, _y, pixel) in qr.enumerate_pixels_mut() {
// //             if pixel.0 == [255, 255, 255, 255] {
// //                 *pixel = image::Rgba([255, 255, 255, 0]);
// //             }
